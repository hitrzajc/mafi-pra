...
for num_layer in range(1,6):
    ...
    for i in range(num_layer):
        dnn.add(Dense(50, input_dim=n_dims, activation=LeakyReLU(alpha=0.01)))
...
plt.xticks(layers)
plt.legend()
plt.title("AUC vs Number of layers fixed epoch=10")
plt.savefig(path+"auc_vs_layers.pdf",dpi=200)
